...
/**
 * Edited wordpress "class-wp-image-editor-imagick.php"
 * 
 * make_subsize() function compares width & height and makes
 * "wp_image_resize_identical_dimensions" filter no effect
 * 
 */
